...
<div class="container-fluid mb-4">
  <div class="card shadow-sm p-4">
      ...
      <ul>
          <li><strong>Sofa Minimalis</strong> - Diskon 20% hanya hari ini!</li>
          <li><strong>Rak Buku Modern</strong> - Beli 2 gratis 1!</li>
          <li><strong>Kursi Kantor Ergonomis</strong> - Cashback 10% untuk pembelian pertama.</li>
      </ul>
  </div>
</div>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="img/promocoba.jpeg" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/promocoba.jpeg" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="img/promocoba.jpeg" alt="Third slide">
      </div>
    </div>
  ...
  <div class="container mb-5">
    <h2 id="dashboard-title" class="text-center my-5">Top Category Picks</h2>
    ...
    <h2 id="dashboard-title" class="text-center my-5">Popular Products</h2>
...
<div class="container my-5">
  <div class="row align-items-center">
      ...
      <div class="col-lg-6 text-center">
          <img src="{{ asset('img/iph.png') }}" class="img-fluid" alt="Phone Image" style="max-width: 250px;">
      </div>

      <!-- Teks Informasi -->
      <div class="col-lg-6">
          <h2 id="dashboard-title">Aplikasi IKEA Indonesia</h2>
          <p>Melalui aplikasi IKEA Indonesia, Anda dapat bergabung menjadi IKEA Family dan mendapatkan banyak reward spesial. Download dan daftar sekarang. GRATIS!</p>

          <!-- Tombol Download -->
          <div class="my-4">
              <a href="#" class="btn btn-outline-dark mr-3">Download di iOS</a>
              <a href="#" class="btn btn-outline-dark">Download di Android</a>
          </div>
          ...
          <div class="mt-4">
              ...
              <a href="#" class="mr-3"><i class="fab fa-pinterest fa-2x"></i></a>
          </div>
      </div>
  </div>
</div>
